...
log_file="C:/Users/Software/Desktop/caseStudy/bash/anomalies_logs.log"
d=$(date +"%Y-%m-%d %H:%M:%S")
...
check_db_connections() {
    local db_connection_failures=$(grep "database connection failure" "C:/Users/Software/Oracle/oradiag_Software/diag/clients/user_Software/host_421332975_80/trace/sqlnet.log" | wc -l)
